            ...
            switch (comando) {
                case 'help':
                    let msg = {embed: {
                            color: 3447003,
                            title: "PIPO 2.0",
                            description: "EL PIPO DE LA PEOPLE",
                            fields: [{
                                name:`${prefix}sonidos`,
                            ...
                            {
                                name:`${prefix}<frase>`,
                                value:"Dice alguna frase (Ej: !pendejo)"
                            },
                            {
                                name:`${prefix}manual`,
                ...
                default:
                    ...
                    if (!voiceChannel) return failure('No estas en ningun canal de voz.');
                    if (!fs.existsSync('./audios/' + comando + '.mp3')) failure('Sonido inexistente.');
